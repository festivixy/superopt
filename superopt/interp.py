...
from superopt.ir import Const, InputRef, Op, Operand, Program, ResultRef, ShiftMode
...
def execute(
    ...
    *,
    ...
    for instruction in program.instructions:
        ...
        results.append(_apply(instruction.op, args, width, mask, shift_mode))

    return value(program.output)


def _apply(
    op: Op, args: Sequence[int], width: int, mask: int, shift_mode: ShiftMode
) -> int:
    match op:
        case Op.ADD:
